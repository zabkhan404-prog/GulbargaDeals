    ...
    <Router>
      <div className="min-h-screen bg-stone-50 font-sans selection:bg-rose-950 selection:text-amber-400 flex flex-col">
        ...
        <header className="bg-rose-950 text-white shadow-xl sticky top-0 z-50">
          <div className="max-w-4xl mx-auto px-4 py-5 flex flex-col items-center relative overflow-hidden">
            ...
            <h1 className="text-4xl font-black font-serif tracking-tight text-white drop-shadow-md z-10 relative">
              Gulbarga <span className="text-amber-400">Deals</span>
            </h1>
            <p 
              onClick={handleSecretTap}
              className="mt-1 text-sm md:text-base text-stone-200 uppercase tracking-[0.2em] font-medium z-10 relative cursor-pointer hover:text-white transition-colors"
            >
